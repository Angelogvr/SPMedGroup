...
using senai.spmedic.WebAPI.Repositories;
using System;
...
namespace senai.spmedic.WebAPI.Controllers
{
    ...
    public class PacientesController : ControllerBase
    {
        ...
        {
            if (novoPaciente.DataDeNascimento < DateTime.Now)
            {
            ...
            else
            {
                ...
                return BadRequest(new { mensagem = "Insira a data corretas" });
            }
        ...
        public IActionResult Atualizar(Paciente pacienteAtualizado)
        {
            try
            {
                if (pacienteAtualizado.DataDeNascimento < DateTime.Now)
                {
                ...
                {
                    return BadRequest(new { mensagem = "Insira a data correta" });
                }
            }
            catch (Exception ex)
            {
